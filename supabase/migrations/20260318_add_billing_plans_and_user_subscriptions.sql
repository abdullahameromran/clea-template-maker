...
values
  (
    ...
    'Free Tier',
    'Starter',
    '100 invoices per month with all templates, custom branding, basic PDF generation, and InvoiceHub watermark.',
    0,
    0,
    'USD',
    false,
  ...
  (
    ...
    'Pro Tier',
    'Most Popular',
    'Best-selling plan for higher limits, watermark-free invoices, saved templates, API access, and priority processing.',
    9,
    19,
    'USD',
    false,
